...
const Contact = () => {
  return (
    <section className="section" id="contact">
      <div className="container lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start reveal-up">
        
        {/* Left section */}
        <div className="mb-12 lg:mb-0">
          <h2 className="mb-6 text-center lg:text-left lg:max-w-[12ch]">
            <ShinyText text="Contact me" speed={2} />
          </h2>
          <p className="text-zinc-400 mb-8 max-w-[50ch] text-center lg:text-left">
          ...
          <div className="flex justify-center lg:justify-start gap-3">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[background-color,color] hover:bg-zinc-50/5 hover:text-zinc-50 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
        ...
        {/* Right section - Form */}
        <form action="https://getform.io/f/bpjzzqeb" method="POST" className="space-y-6">
          
          {/* Name */}
          <div className="flex flex-col md:grid md:grid-cols-3 md:items-center md:gap-4">
            <label htmlFor="name" className="label md:text-right">
              Name
            </label>
            <input
              type="text"
          ...
          {/* Email */}
          <div className="flex flex-col md:grid md:grid-cols-3 md:items-center md:gap-4">
            <label htmlFor="email" className="label md:text-right">
              Email
            </label>
            <input
              type="email"
          ...
          {/* Message */}
          <div className="flex flex-col md:grid md:grid-cols-3 md:items-start md:gap-4">
            <label htmlFor="message" className="label md:text-right">
              Message
            </label>
            <textarea
              name="message"
              ...
              placeholder="Hi!"
              required
              className="text-field md:col-span-2 h-32 resize-none"
            ></textarea>
          </div>
